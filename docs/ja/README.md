...
| [内部設計](https://github.com/SpreadWorks/sdd-forge/blob/main/docs/ja/internal_design.md) | このプロジェクトは、src/check・src/docs・src/flow・src/lib の各層に責務を分離し、CLI コマンド層から共通ライブラリ層へ依存する一方向の構成で実装されています。 |

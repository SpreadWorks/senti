...
| src | 12 | check command entrypoint, docs command entrypoint, Render localized help for core and plugin commands., hook command bootstrap, Metrics command entrypoint, cli, CLI entrypoint for preset inspection and tree rendering., Top-level CLI router and command bootstrapper, spec command namespace entrypoint |

...
| src | 12 | check command entrypoint, docs command entrypoint, flow CLI entrypoint, CLI help generator, hook command bootstrap, Metrics command entrypoint, top-level CLI dispatcher, project setup command, spec command namespace entrypoint, legacy project upgrade command |

...
| src | 12 | check command entrypoint, docs command entrypoint, flow CLI entrypoint, Render localized help for core and plugin commands., hook command bootstrap, Metrics command entrypoint, Plugin CLI command dispatcher, CLI entrypoint for preset inspection and tree rendering., Serve as the main CLI dispatcher and help gateway., Project setup command and bootstrap workflow, spec command namespace entrypoint, CLI upgrade command entrypoint and legacy migration engine |

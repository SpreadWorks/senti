...
describe("spec 251: FLOW_DEFINITION impl children order", () => {
  it("R1: impl branch children are ordered through test execution before review and gate", () => {
    ...
    assert.deepEqual(ids, ["implement", "test-execute", "test-result-review", "review", "gate-impl", "retro", "finalize"]);
  });

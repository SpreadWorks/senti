...
test("acceptance-review exposes validated upgrade evidence for changed skill sources", () => {
  ...
  const diff = [
    "diff --git a/src/skills/sennel.flow/SKILL.md b/src/skills/sennel.flow/SKILL.md",
    "--- a/src/skills/sennel.flow/SKILL.md",
    "+++ b/src/skills/sennel.flow/SKILL.md",
    "",
  ].join("\n");
  ...
  assert.deepEqual(context.evidence.upgradeEvidence, {
    required: true,
    requiredPaths: ["src/skills/sennel.flow/SKILL.md"],
    valid: true,

...
export const FLOW_COMMANDS = {
  park: {
    helpKey: "flow.park",
    helpPath: "sennel flow park --help",
    requiresFlow: false,
    targetGuard: false,
    ...
    help: [
      `Usage: sennel flow park ${FLOW_TARGET_GUARD_USAGE}`,
      "",
  ...
  resume: {
    ...
    help: [
      `Usage: sennel flow resume [--spec <specId>] [--parked] ${FLOW_TARGET_GUARD_USAGE}`,
      "",
  ...
  run: {
    ...
    direct: {
      ...
      help: [
        `Usage: sennel flow run direct [--record-id <id>] [--agent-work-dir <path>] ${FLOW_TARGET_GUARD_USAGE}`,
        "",

   ...
   - Run `sennel flow run review` to perform AI-powered code review.
   ...
   - **Retry limit:** Each `sennel flow run review` invocation = 1 attempt (CLI invocation level). The CLI enforces this flow-scope limit (spec 253).

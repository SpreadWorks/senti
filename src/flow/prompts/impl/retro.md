   ...
   - **Invocation:** run `senrail flow run retro` (the runner is responsible for reading artifacts and writing `retro.json`). The mainline run unconditionally overwrites the existing file.

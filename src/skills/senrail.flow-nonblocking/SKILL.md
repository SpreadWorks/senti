...
5. Record exactly one guarded decision:
   ...
   `senrail flow set nonblocking-decision --choice <repair|retry|continue> --reason "<reason>" --expect-evidence-digest <sha256> [--remaining-risk "<risk>"]`

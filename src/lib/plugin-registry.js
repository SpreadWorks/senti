...
const FLOW_COMMANDS = new Set(["prepare", "gate", "review", "test-execute", "test-result-review", "retro", "acceptance-review", "final-regression", "report", "finalize-commit", "finalize-merge", "finalize-sync", "finalize-cleanup"]);
